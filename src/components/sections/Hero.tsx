      ...
      <div className="flex flex-col items-center space-y-6 sm:space-y-8 select-none relative z-10 w-full max-w-4xl">
        <div
          ...
          style={{
            ...
            transition: prefersReducedMotion ? "none" : "0.8s cubic-bezier(0.34, 1.56, 0.64, 1) 0.3s",
          }}
        >
              ...
              <span
                ...
                style={{
                  ...
                  transition: prefersReducedMotion
                    ? "none"
                    : `0.7s cubic-bezier(0.34, 1.56, 0.64, 1) ${0.4 + idx * 0.08}s`,
        ...
        <div className="flex flex-col items-center">
          <h2
            ...
            style={{
              ...
              transition: prefersReducedMotion ? "none" : "0.8s cubic-bezier(0.34, 1.56, 0.64, 1) 1.1s",
            }}
          >
          ...
          <div
            ...
            style={{
              ...
              transition: prefersReducedMotion ? "none" : "1s cubic-bezier(0.34, 1.56, 0.64, 1) 1.3s",
            }}
          />
        </div>
      </div>
