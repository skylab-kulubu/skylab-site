    ...
    >
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        ...
        >
          ...
          <div
            ref={scrollRef}
            className="flex gap-5 md:gap-6 items-stretch overflow-x-auto scroll-smooth pb-12 pt-8 px-2 -mx-2 [&::-webkit-scrollbar]:hidden"
            style={{
              scrollbarWidth: "none",
        ...
        <div
          className={cn(
            "pt-10 flex items-center justify-center gap-2 transition-all duration-1000 ease-out",
        ...
        >
          ...
          />
          <div
            className="h-1.5 w-1.5 rounded-full bg-purple-400/60 animate-pulse"
            style={{
